#smack-hub
> Anonymously smack (or high five) people you run into.

[![Build Status](https://travis-ci.org/nickick/smack-hub.svg?branch=master)](https://travis-ci.org/nickick/smack-hub) [![Dependency Status](https://david-dm.org/nickick/smack-hub.svg)](https://david-dm.org/nickick/smack-hub) [![devDependency Status](https://david-dm.org/nickick/smack-hub.svg)](https://david-dm.org/nickick/smack-hub#info=devDependencies)
...
## Release History
 * 2014-05-09   v0.1.0   Generated by the [Yeoman Generator](https://github.com/famous/generator-famous) for [Famo.us](http://famo.us)